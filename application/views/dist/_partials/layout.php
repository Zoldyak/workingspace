    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <?php
          $query = $this->db->get_where('working_booking', array('terbaca_admin' => "baru"));
        ...
        <?php  } ?>
          ...
          <div class="dropdown-menu dropdown-list dropdown-menu-right">
              ...
              <div class="dropdown-list-content dropdown-list-icons">
                <a href="<?php echo base_url(); ?>Administrator/Booking" class="dropdown-item dropdown-item-unread">
                  ...
                  <div class="dropdown-item-desc">
                  <span class="badge badge-danger">New Booking</span>
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">Hi, <?php echo $this->session->userdata('user_nama') ?></div></a>
