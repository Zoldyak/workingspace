...
<section class="property-section" style="background-color:#f4f5f7">
  <div class="container" >
    <div class="section-title">
      <br>
      <h4 class="">Cara Mudah Untuk Memesan Coworking Space</h4>
    </div>
    <div class="row" >
      <div class="col-lg-4">
  ...
  <div class="container">
    ...
    <div class="row intro-first">
      <div class="col-lg-6 order-lg-2">
        <img src="<?php echo base_url(); ?>/assets/frontend/img/about/1.jpg" alt="">
      </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        <img src="<?php echo base_url(); ?>/assets/frontend/img/about/2.jpg" alt="">
      </div>
      <div class="col-lg-6 ">
        <div class="about-text">
